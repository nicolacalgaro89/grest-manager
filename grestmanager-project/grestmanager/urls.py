...
urlpatterns = [
    ...
    path("persons/<int:person_id>/subscriptions/<int:subscription_id>/update/", views.SubscriptionUpdateView.as_view(), name="subscription_update"),
    path("persons/<int:person_id>/subscriptions/<int:subscription_id>/confirm/", views.subscription_confirm, name="subscription_confirm"),
    path("persons/<int:person_id>/subscriptions/<int:subscription_id>/paid/", views.subscription_mark_paid, name="subscription_mark_paid"),
